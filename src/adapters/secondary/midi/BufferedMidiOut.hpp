...
/**
 * @brief Wrapper pour MidiOutputPort qui bufferise les messages et les envoie à intervalles
 * réguliers
 *
 ...
 */
class BufferedMidiOut : public MidiOutputPort {
public:
    ...
    struct MidiMessage {
        ...
        uint16_t
            hashNext;  // Index du prochain message dans la même entrée de hachage (ou UINT16_MAX)
...
private:
    ...
    MidiMessage
        staticBuffer_[STATIC_BUFFER_SIZE];  // Buffer statique pour éviter l'allocation dynamique
