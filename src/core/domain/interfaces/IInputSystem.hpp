...
public:
     ...
     * @return Result<bool, std::string> Succès ou message d'erreur
     */
    virtual Result<bool, std::string> configureEncoders(const std::vector<EncoderConfig>& encoderConfigs) = 0;
     ...
     * @return Result<bool, std::string> Succès ou message d'erreur
     */
    virtual Result<bool, std::string> configureButtons(const std::vector<ButtonConfig>& buttonConfigs) = 0;
};