    ...
    midiMappings = {
        ...
        {.controlId = 71,
         .midiControl = {.channel = 0,
                         ...
                         .relative = true,
                         .controlType =
                             ControlType::ENCODER_ROTATION}},  // Encodeur 1 -> CC 1, Canal 1
        ...
        {.controlId = 72,
         .midiControl = {.channel = 0,
                         ...
                         .relative = true,
                         .controlType =
                             ControlType::ENCODER_ROTATION}},  // Encodeur 2 -> CC 2, Canal 1
        ...
        {.controlId = 73,
         .midiControl = {.channel = 0,
                         ...
                         .relative = true,
                         .controlType =
                             ControlType::ENCODER_ROTATION}},  // Encodeur 3 -> CC 3, Canal 1
        ...
        {.controlId = 74,
         .midiControl = {.channel = 0,
                         ...
                         .relative = true,
                         .controlType =
                             ControlType::ENCODER_ROTATION}},  // Encodeur 4 -> CC 4, Canal 1
        ...
        {.controlId = 75,
         .midiControl = {.channel = 0,
                         ...
                         .relative = true,
                         .controlType =
                             ControlType::ENCODER_ROTATION}},  // Encodeur 5 -> CC 5, Canal 1
        ...
        {.controlId = 76,
         .midiControl = {.channel = 0,
                         ...
                         .relative = true,
                         .controlType =
                             ControlType::ENCODER_ROTATION}},  // Encodeur 6 -> CC 6, Canal 1
        ...
        {.controlId = 77,
         .midiControl = {.channel = 0,
                         ...
                         .relative = true,
                         .controlType =
                             ControlType::ENCODER_ROTATION}},  // Encodeur 7 -> CC 7, Canal 1
        ...
        {.controlId = 78,
         .midiControl = {.channel = 0,
                         ...
                         .relative = true,
                         .controlType =
                             ControlType::ENCODER_ROTATION}},  // Encodeur 8 -> CC 8, Canal 1
        ...
        {.controlId = 80,
         .midiControl = {.channel = 0,
                         ...
                         .relative = true,
                         .controlType =
                             ControlType::ENCODER_ROTATION}},  // Encodeur optique -> CC 10, Canal 1
        ...
        {.controlId = 71,
         .midiControl = {.channel = 0,
                         .control = 36,
                         .relative = true,
                         .controlType = ControlType::ENCODER_BUTTON}},  // Bouton Encodeur 1 -> Note
                                                                        // 36, Canal 1
        ...
        {.controlId = 72,
         .midiControl = {.channel = 0,
                         .control = 37,
                         .relative = true,
                         .controlType = ControlType::ENCODER_BUTTON}},  // Bouton Encodeur 2 -> Note
                                                                        // 37, Canal 1
        ...
        {.controlId = 73,
         .midiControl = {.channel = 0,
                         .control = 38,
                         .relative = true,
                         .controlType = ControlType::ENCODER_BUTTON}},  // Bouton Encodeur 3 -> Note
                                                                        // 38, Canal 1
        ...
        {.controlId = 74,
         .midiControl = {.channel = 0,
                         .control = 39,
                         .relative = true,
                         .controlType = ControlType::ENCODER_BUTTON}},  // Bouton Encodeur 4 -> Note
                                                                        // 39, Canal 1
        ...
        {.controlId = 75,
         .midiControl = {.channel = 0,
                         .control = 40,
                         .relative = true,
                         .controlType = ControlType::ENCODER_BUTTON}},  // Bouton Encodeur 5 -> Note
                                                                        // 40, Canal 1
        ...
        {.controlId = 76,
         .midiControl = {.channel = 0,
                         .control = 41,
                         .relative = true,
                         .controlType = ControlType::ENCODER_BUTTON}},  // Bouton Encodeur 6 -> Note
                                                                        // 41, Canal 1
        ...
        {.controlId = 77,
         .midiControl = {.channel = 0,
                         .control = 42,
                         .relative = true,
                         .controlType = ControlType::ENCODER_BUTTON}},  // Bouton Encodeur 7 -> Note
                                                                        // 42, Canal 1
