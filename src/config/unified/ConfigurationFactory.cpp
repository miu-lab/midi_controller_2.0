...
std::unique_ptr<UnifiedConfiguration> ConfigurationFactory::createDefaultConfiguration() {
    ...
    config->addControl(
        ControlBuilder(80, "optical_encoder")
            .withLabel("Precision")
            .inGroup("Precision")
