...
public:
    explicit ViewManagerMock(IDisplay& display) : display_(display) {}
    ...
    int getCurrentMenuIndex() const override { return 0; }
    ...
    bool isModalDialogOkSelected() const override { return true; }
